...
function changeBg(status) {
    if (status === 'Clouds') {
        ...
        document.body.style.backgroundImage = 'url(pic3.jpeg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(pic4.jpeg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(pic5.jpeg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(pic6.webp)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(pic7.jpeg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(pic3.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(pic9.webp)';
    }
    else {
        document.body.style.backgroundImage = 'url(pic10.jpeg)';
    }
}
